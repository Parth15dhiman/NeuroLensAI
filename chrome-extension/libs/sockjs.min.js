/* sockjs-client v1.5.1 | http://sockjs.org | MIT license */ ! function(e) {
    ...
    return function i(s, a, l) {
        ...
        5: [function(e, t, n) {
            ...
            r.prototype.addEventListener = function(e, t) {
                ...
                if (n) {
                    var r = n.indexOf(t); - 1 === r || (1 < n.length ? this._listeners[e] = n.slice(0, r).concat(n.slice(r + 1)) : delete this._listeners[e])
                }
        ...
        15: [function(e, t, n) {
            ...
            d(c, {
                indexOf: function(e, t) {
                    ...
                    for (1 < arguments.length && (o = function(e) {
                        ...
                        }(t)), o = 0 <= o ? o : Math.max(0, r + o); o < r; o++)
            ...
            2 !== "ab".split(/(?:ab)*/).length || 4 !== ".".split(/(.?)(.?)/).length || "t" === "tesst".split(/(s)*/)[1] || 4 !== "test".split(/(?:)/, -1).length || "".split(/.?/).length || 1 < ".".split(/()()/).length ? (_ = void 0 === /()??/.exec("")[1], s.split = function(e, t) {
                ...
                for (e = new RegExp(e.source, l + "g"), n += "", _ || (r = new RegExp("^" + e.source + "$(?!\\s)", l)), t = void 0 === t ? -1 >>> 0 : function(e) {
                    ...
                    (o = e.exec(n)) && !(u < (i = o.index + o[0].length) && (a.push(n.slice(u, o.index)), !_ && 1 < o.length && o[0].replace(r, function() {
            ...
            (function(i) {
                ...
                e(c, l), c.prototype.abort = function() {
                    ...
                    if (r.id = "a" + s.string(8), r.src = e, r.type = "text/javascript", r.charset = "UTF-8", r.onerror = this._scriptError.bind(this), r.onload = function() {
                        ...
                        if (a.isOpera())(t = this.script2 = i.document.createElement("script")).text = "try{var a = document.getElementById('" + r.id + "'); if(a)a.onerror();}catch(x){};", r.async = t.async = !1;
                        else {
                            try {
            ...
            (function(f) {
                ...
                p.exports = {
                    ...
                    createHtmlfile: function(e, t) {
                        ...
                        var i, s, a, l = ["Active"].concat("Object").join("X"),
                            u = new f[l]("htmlfile");
                ...
                (function() {
                    ...
                    function F(e, l) {
                        ...
                        var u = e.Number || B.Number,
                            ...
                            t = e.Object || B.Object,
                            v = e.Date || B.Date,
                            n = e.SyntaxError || B.SyntaxError,
                            b = e.TypeError || B.TypeError,
                            d = e.Math || B.Math,
                            r = e.JSON || B.JSON;
                        ...
                        function f(e) {
                            ...
                            if ("bug-string-char-index" == e) t = "a" != "a" [0];
                            else if ("json" == e) t = f("json-stringify") && f("date-serialization") && f("json-parse");
                                ...
                                if ("json-stringify" == e) {
                                    ...
                                    i && ((r = function() {
                                        ...
                                        i = "0" === n(0) && "0" === n(new u) && '""' == n(new c) && n(g) === y && n(y) === y && n() === y && "1" === n(r) && "[1]" == n([r]) && "[null]" == n([y]) && "null" == n(null) && "[null,null,null]" == n([y, g, null]) && n({
                                            "a": [r, !0, !1, null, "\0\b\n\f\r\t"]
                                        }) == o && "1" === n(null, r) && "[\n 1,\n 2\n]" == n([1, 2], null, 1)
                                    }, function() {
                                        i = !1
                        ...
                        if (w(function() {
                            ...
                            if (!f("json-stringify") && !f("date-serialization")) {
                                ...
                                if (f("json-stringify") && !f("date-serialization")) {
                                    ...
                                    var A = /[\x00-\x1f\x22\x5c]/g,
                                        k = function(e, t, n, r, o, i, s) {
                                ...
                                var R, U, M = c.fromCharCode,
                                    ...
                                    D = function(e) {
                                        ...
                                        if ("$" == e && I(), "string" == typeof e) {
                                            ...
                                            if ("[" == e) {
                                                for (t = [];
                                                    "]" != (e = L());) n ? "," == e ? "]" == (e = L()) && I() : I() : n = !0, "," == e && I(), t.push(D(e));
                                                return t
                                            }
                                            if ("{" == e) {
                                                for (t = {};
                                                    "}" != (e = L());) n ? "," == e ? "}" == (e = L()) && I() : I() : n = !0, "," != e && "string" == typeof e && "@" == (m ? e.charAt(0) : e[0]) && ":" == L() || I(), t[e.slice(1)] = D(L());
                                                return t
                                            }
                                            I()
                                        }
                    ...
                    if (!t || t.global !== t && t.window !== t && t.self !== t || (B = t), e) F(B, e);
                    else {
                        var n = B.JSON,
                            r = B.JSON3,
                            o = !1,
        ...
        58: [function(e, r, t) {
            (function(i) {
                ...
                function b(e) {
                    var t, n = ("undefined" != typeof window ? window : void 0 !== i ? i : "undefined" != typeof self ? self : {}).location || {},
                        r = {},
                        o = typeof(e = e || n);
                    if ("blob:" === e.protocol) r = new g(unescape(e.pathname), {});
                    else if ("string" == o)
                        for (t in r = new g(e, {}), a) delete r[t];
                    else if ("object" == o) {
